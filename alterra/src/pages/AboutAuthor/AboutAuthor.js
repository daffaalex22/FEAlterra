...
const AboutAuthor = () => {
    return (
        <div className="about-author container w-75">
            <h1>About Author</h1>
            <br />
            <p>
                ...
                Fugiat harum numquam corporis iusto odit ut, non minus, vel minima est veniam omnis? Pariatur exercitationem nesciunt ex, in amet magnam veniam ullam, voluptates veritatis consequatur quasi, eligendi nulla inventore.
            </p>
        </div>
    );
}
